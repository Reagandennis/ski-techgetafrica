...
<div class="container-md section-py">
	<div class="grid lg:grid-cols-3 gap-12">
		...
		<div class="lg:col-span-2 space-y-8">
			<!-- Header -->
			<header>
				<p class="text-sm text-gray-600 mb-2">{course.difficulty}</p>
		...
		<aside class="space-y-6">
			<div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
				...
				<ul class="mt-6 space-y-4 text-gray-700">
					<li class="flex items-center gap-3">
						...
						<span><strong>4.7</strong> (0 ratings)</span>
					</li>
					<li class="flex items-center gap-3">
			...
			<div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
				...
				<div class="flex items-center gap-3">
						{#if course.organizationLogo}
							<img src={course.organizationLogo} alt={course.organizationName} class="w-10 h-10 rounded-full" />
					{/if}
						<span class="font-medium">{course.organizationName}</span>
				</div>
			</div>
		</aside>
	</div>
