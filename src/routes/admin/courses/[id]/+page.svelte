...
<div class="space-y-6">
	<div>
		...
		<p class="text-gray-600 mt-1">Update the details for "{course.title}".</p>
	</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			...
			<div>
				...
				<input
					...
					required
					bind:value={course.organization_name}
					class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-red focus:border-brand-red"
				/>
			</div>
			...
			<div>
				...
				<input
					...
					bind:value={course.organization_logo}
					class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-red focus:border-brand-red"
				/>
			</div>
			...
			<div>
				...
				<select
					...
					required
					bind:value={course.certification_type}
					class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-red focus:border-brand-red"
				>
			...
			<div class="relative">
				...
				<div class="mt-1 relative rounded-md shadow-sm">
					...
					<input
						...
						name="original_price"
						id="original_price"
						bind:value={course.original_price}
						class="block w-full rounded-md border-gray-300 pl-12 focus:border-brand-red focus:ring-brand-red"
						placeholder="0.00"
						step="0.01"
					/>
